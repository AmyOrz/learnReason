    ...
    for (var typeSpecName in typeSpecs) {
      if (typeSpecs.hasOwnProperty(typeSpecName)) {
        ...
        try {
          // This is intentionally an invariant that gets caught. It's the same
          // behavior as without this statement except with a better message.
          invariant$7(typeof typeSpecs[typeSpecName] === 'function', '%s: %s type `%s` is invalid; it must be a function, usually from ' + 'the `prop-types` package, but received `%s`.', componentName || 'React class', location, typeSpecName, typeof typeSpecs[typeSpecName]);
...
function invariant$8(condition, format, a, b, c, d, e, f) {
...
var warning$10 = emptyFunction$4;

{
  ...
  warning$10 = function warning(condition, format) {
    if (format === undefined) {
      throw new Error('`warning(condition, format, ...args)` requires a warning ' + 'message argument');
    }
...
var createClass$1 = factory$2(Component, isValidElement$1, ReactNoopUpdateQueue$2);
...
function onlyChild$1(children) {
  !ReactElement$5.isValidElement(children) ? invariant$9(false, 'React.Children.only expected to receive a single React element child.') : void 0;
  return children;
}
...
var createReactClass = createClass$1;
...
function _assign$4(prim, prim$1) {
...
function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
  ...
  var RESERVED_SPEC_KEYS = {
    ...
    childContextTypes: function(Constructor, childContextTypes) {
      ...
      //   validateTypeDef(Constructor, childContextTypes, 'childContext');
      // }
      Constructor.childContextTypes = _assign$4(
        {},
        Constructor.childContextTypes,
        childContextTypes
      );
    ...
    contextTypes: function(Constructor, contextTypes) {
      ...
      //   validateTypeDef(Constructor, contextTypes, 'context');
      // }
      Constructor.contextTypes = _assign$4(
        {},
        Constructor.contextTypes,
        contextTypes
      );
    ...
    propTypes: function(Constructor, propTypes) {
      ...
      //   validateTypeDef(Constructor, propTypes, 'prop');
      // }
      Constructor.propTypes = _assign$4({}, Constructor.propTypes, propTypes);
    },
    statics: function(Constructor, statics) {
      mixStaticSpecIntoComponent(Constructor, statics);
    },
...
var createClass$3 = factory$4(react_1, undefined, reactNoopUpdateQueue);
...
var store = Store[/* create */0](countReducer, 10, /* None */0, /* () */0);
...
function appReducer(state, action) {
  if (action.tag) {
    return /* record */[
            /* counter */countReducer(state[/* counter */0], action[0]),
...
Store[/* subscribe */2](store, (function () {
        console.log(Store[/* getState */5](store));
        return /* () */0;
      }));

var partial_arg = Store[/* dispatch */4];
...
Store[/* replaceReducer */6](store, doubleCountReducer);
...
var partial_arg$1 = Store[/* dispatch */4];

function complexDispath(param) {
  return partial_arg$1(store$1, param);
}

complexDispath(/* StringAction */__(0, [/* A */0]));

complexDispath(/* StringAction */__(0, [/* A */0]));

complexDispath(/* StringAction */__(0, [/* B */1]));

complexDispath(/* StringAction */__(0, [/* B */1]));

complexDispath(/* CountAction */__(1, [/* Increment */0]));
...
var compleState = Store[/* getState */5](store$1);
...
exports.complexDispath = complexDispath;
exports.compleState = compleState;
